      ...
      <div className="bg-gray-950 px-10 md:px-36 pb-10">
        <section className="container mt-12 ">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-white mt-4 leading-relaxed font-light">
              I'm Nate Wells, a business coach and network marketing
              professional with a passion for helping individuals and teams
              achieve financial independence and personal growth. Through years
              of experience in the field, I've had the privilege of guiding
              aspiring entrepreneurs and business owners on their journeys to
              success. Let's connect and make things happen!
            </p>
          </div>
        </section>
        ...
        <section className="container mt-12">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-white mt-4 leading-relaxed font-light">
              Ready to take your business to the next level? Let's collaborate
              to create a powerful strategy that aligns with your goals. Click
              below to start an exciting journey of growth and achievement.
            </p>
            <Link
              href="/work-with-me"
