...
import { fetchAvailableDates } from '@/src/services/bookingServices';
import { CalendarSkeleton } from './BookingSkeleton';
import TimezoneSelect from './TimeZoneSelect';
import Availabilities from '@/src/types/AvailabilitiesType';
import SelectedDate from '@/src/types/SelectedDateType';
import { useQuery } from '@tanstack/react-query';
import { DAYS, TIMEZONEOPTIONS } from '@/lib/constants';
import TimezoneOption from '@/src/types/TimezoneType';
