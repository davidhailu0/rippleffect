...
const NoBookingMessage = () => (
    <div className="flex flex-col items-center justify-center h-1/2 text-center">
        ...
        <Link href="/work-with-me/book" className="px-6 py-3 bg-pink-400 text-white hover:bg-pink-600 transitionh-12 rounded-[50px] shadow-xl font-bold mt-8 col-span-2 w-[260px] mx-auto text-center box-border pt-3">
            Book a Call
        </Link>
    </div>
);
