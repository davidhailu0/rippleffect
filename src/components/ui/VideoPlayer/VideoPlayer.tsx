...
const VideoPlayer: React.FC<VideoPlayerProps> = ({
  ...
  return (
    <MuxPlayer
      ref={videoRef as any}
      className={`shadow-custom-shadow md:w-10/12 w-full md:h-full sm:h-full aspect-[854/480] object-contain hover:cursor-pointer overflow-x-hidden relative ${className}`}
