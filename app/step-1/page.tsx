...
export default function Home() {
    return (
        <>
            <Navbar />
            <div className="flex flex-col gap-7 mt-7 items-center h-full w-[1100px] mx-auto">
                <p className="text-4xl font-bold text-white mb-9">Step 1</p>
                <VideoPlayer src="https://storage.googleapis.com/msgsndr/C6nqv5N0ZUkTMUIxNoYx/media/6638c58eb478503bf929064b.mp4" />
                <div className="flex flex-col mt-7">
                    <p className={`text-white ${lato.className}`}>Once you have <span className="font-medium text-[#d7b398]">watched the videos</span> click the button below to continue to step 2</p>
