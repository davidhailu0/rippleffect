    ...
    return <>
        ...
        <div className={`flex-col w-full mt-8`}>
            ...
            <div className="flex mt-8 flex-col md:flex-row">
                ...
                <Link href={'/book'} className={`${show ? 'block' : 'hidden'} bg-gradient-to-r from-[#18455F] via-[#4B7A87] to-black h-12 rounded-[50px] text-white shadow-xl font-bold mt-8 col-span-2 w-[260px] mx-auto md:mb-7 text-center box-border pt-3`}>Book Call</Link>
            </div>
        </div>
    </>
}