...
const BookedContent = () => (
    <>
        ...
        <p className="text-base font-light text-white text-center my-7">
            To fully benefit from your call and ensure you understand our business model,
            please make sure to watch the following series of videos <strong>before</strong> we talk.
            If you are unable to watch the videos beforehand, we may not be able to proceed with your call.
        </p>
