    ...
    return (
        <>
            <div className="flex flex-col gap-4 md:gap-5 md:mt-7 items-start w-[95%] md:w-[85%] mx-auto">
                ...
                <p className={`text-[rgba(255,255,255,0.57)] md:text-center text-lg px-0 leading-7 md:text-lg font-medium md:leading-[23.4px] mb-4 md:mb-9`}>Choose your favorite Landing Page and Copy Your Personal Link</p>
