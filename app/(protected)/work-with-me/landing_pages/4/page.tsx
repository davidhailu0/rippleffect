        ...
        <div className="flex flex-col items-center h-screen bg-gray-900 bg-opacity-90 overflow-hidden">
            <div className="w-full max-w-4xl p-4">
                <header className="text-center mb-10">
                    <h1 className="text-5xl font-bold text-white">Discover Our Lead System</h1>
                    <p className="text-gray-300 mt-2">Join thousands of others in growing your business.</p>
                </header>
