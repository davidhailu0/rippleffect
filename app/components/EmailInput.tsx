...
interface EmailInputProps {
  ...
  handleSubmit: (e: React.FormEvent) => void; // handleSubmit is a function for form submission
...
const EmailInput: React.FC<EmailInputProps> = ({ email, setEmail, handleSubmit, loading, ctaText = "Get Started" }) => {
  return (
    <form onSubmit={handleSubmit} className="w-full max-w-sm bg-white rounded-lg p-6">
      <input
        type="email"
        value={email}
