    ...
    return (
        <>
            ...
            <div className="flex flex-col gap-5 mt-7 items-center w-full md:w-9/12 mx-auto px-2">
                <Image src={'/uk.png'} alt='EU' height={100} width={100} unoptimized />
                ...
                <VideoPlayer videoID={step_3_gbp_strt!.id} onVideo80={handleVideoEnd} playBackId={step_3_gbp_strt!.mux_playback_id} />
