...
export default function Home() {
    return (
        <>
            <Navbar />
            <div className="flex flex-col gap-5 mt-7 items-center h-full w-[1120px] mx-auto">
                <Image src={'/eu.png'} alt='EU' height={100} width={100} />
                <p className="text-[#d7b398] text-2xl font-bold">Welcome</p>
                <p className="text-4xl font-bold text-white">My Current Business Model</p>
                <p className="text-2xl font-bold text-gray-400 mb-5">In this 4 Video Module, you will learn about</p>
