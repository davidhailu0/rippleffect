            ...
            <div className="flex flex-col gap-7 mt-7 items-center w-full md:w-9/12 mx-auto px-4">
                ...
                <div className="flex flex-col w-full mt-8">
                    ...
                    <div className="flex mt-8 flex-col md:flex-row">
                        ...
                        <Link href={'/book'} className="bg-gradient-to-r from-[#18455F] to-black h-12 rounded-[50px] text-white font-bold mt-8 col-span-2 w-[260px] mx-auto md:mb-7 text-center box-border flex items-center justify-center">Book your Call<Image src='/Call.png' alt="Call" className="inline ml-4" height={32} width={32} /></Link>
                        <Link href={'/step-3'} className="bg-gradient-to-r from-[#18455F] via-[#4B7A87] to-black h-12 rounded-[50px] text-white shadow-xl font-bold mt-8 col-span-2 w-[260px] mx-auto md:mb-7 text-center box-border pt-3">Next &gt;</Link>
                    </div>
                </div>
            </div>
        </>
